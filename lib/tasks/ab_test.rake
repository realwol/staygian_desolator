namespace :ab_test do
  ...
  task :local => :environment do
    ...
    puts 'local result'
    puts '*************************'
    exec 'ab -n 1000 -c 100 http://0.0.0.0:5001/variables/variable_translate_list'
  end
  ...
  task :server => :environment do
    ...
    puts 'server result'
    puts '*************************'
    exec 'ab -n 1000 -c 100 http://120.25.74.164:3001/variables/variable_translate_list'
  end
