...
ActiveRecord::Schema.define(version: 20161127161457) do
  ...
  create_table "brands", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.boolean  "has_stand_by", limit: 1,   default: false
  end
  ...
  add_index "description_translation_histories", ["description"], name: "index_description_translation_histories_on_description", length: {"description"=>20}, using: :btree
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.float    "principal_rmb",                          limit: 24
    ...
    t.float    "shipping_charge_rmb",                    limit: 24
    ...
    t.float    "commission_rmb",                         limit: 24
